...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { address: @visitor.address, mail: @visitor.mail, name: @visitor.name, phone: @visitor.phone } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { address: @visitor.address, mail: @visitor.mail, name: @visitor.name, phone: @visitor.phone } }
