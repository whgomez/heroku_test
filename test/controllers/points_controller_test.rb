...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { convention: @point.convention, coordinate: @point.coordinate, description: @point.description } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { convention: @point.convention, coordinate: @point.coordinate, description: @point.description } }
